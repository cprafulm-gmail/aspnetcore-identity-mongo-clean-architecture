...
namespace UserAuthentications.Infrastructure.Persistence
{
    public static class Pagination
    {
            ...
            string sortOrder, int page = 1, int resultsPerPage = 10)
        {
            ...
            var maxTotalAmount = 100000;//await collection.MaxAsync(x => x.TotalAmount);
            ...
            if (string.IsNullOrWhiteSpace(orderBy))
            {
                ...
                return PagedResult<T>.Create(data, maxTotalAmount, page, resultsPerPage, totalPages, totalResults);
            }
